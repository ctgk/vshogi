...
private:
    ...
    {
        constexpr std::uint64_t m1 = 0x5555555555555555; //binary: 0101...
        constexpr std::uint64_t m2 = 0x3333333333333333; //binary: 00110011..
        constexpr std::uint64_t m4
            = 0x0f0f0f0f0f0f0f0f; //binary:  4 zeros,  4 ones ...
        constexpr std::uint64_t m8
            = 0x00ff00ff00ff00ff; //binary:  8 zeros,  8 ones ...
        constexpr std::uint64_t m16
            = 0x0000ffff0000ffff; //binary: 16 zeros, 16 ones ...
        constexpr std::uint64_t m32
            = 0x00000000ffffffff; //binary: 32 zeros, 32 ones
        constexpr std::uint64_t h01
