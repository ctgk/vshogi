...
constexpr PieceTypeEnum init_piece_array[] = {FU, KY, KE, GI, KA, HI, KI, OU};
constexpr PieceTypeEnum stand_piece_array[] = {FU, KY, KE, GI, KA, HI, KI};
...
inline constexpr bool is_promotable(const PieceTypeEnum p)
{
    return (p < 0b0110);
}
inline constexpr bool is_promotable(const BoardPieceTypeEnum p)
{
...
inline constexpr PieceTypeEnum promote(const PieceTypeEnum p)
{
    return static_cast<PieceTypeEnum>(p | 0b01000);
}
inline constexpr BoardPieceTypeEnum promote(const BoardPieceTypeEnum p)
{
    return static_cast<BoardPieceTypeEnum>(p | 0b01000);
}

inline constexpr PieceTypeEnum demote(const PieceTypeEnum p)
{
    return static_cast<PieceTypeEnum>(p & 0b0111);
}
inline constexpr BoardPieceTypeEnum demote(const BoardPieceTypeEnum p)
{
