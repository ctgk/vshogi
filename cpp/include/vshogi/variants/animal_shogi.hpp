...
struct Config
{
    ...
    static constexpr uint piece_type_to_value[] = {5, 30, 35, 0, 60, 0};
    static constexpr uint sum_piece_value = 2 * (60 + 30 + 35);
...
template <>
inline void animal_shogi::Game::whole_attention_matrix(float* const data)
{
    local_attention_matrix(data);
}

template <>
inline void animal_shogi::Game::ranging_attention_matrix(
