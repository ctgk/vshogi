...
constexpr uint num_attack_types = 15; // B_FU, W_FU, B_KY, W_KY, B_KE, W_KE, B_GI, W_GI, B_KI, W_KI, KA, HI, OU, UM, RY
...
using BitBoard
    = vshogi::BitBoard<UInt128, Squares, BoardPieceTypeEnum, num_attack_types>;
#endif
