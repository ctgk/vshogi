...
TEST(judkins_shogi_pieces, is_promotable)
{
    ...
    CHECK_FALSE(PieceTraits::is_promotable(NA));
    ...
    CHECK_FALSE(PieceTraits::is_promotable(VOID));
}
...
TEST(judkins_shogi_pieces, is_promoted)
{
    ...
    CHECK_TRUE(PieceTraits::is_promoted(NA));
...
TEST(judkins_shogi_pieces, promote)
{
    ...
    // CHECK_EQUAL(KI, PieceTraits::promote_nocheck(KI));
    // CHECK_EQUAL(OU, PieceTraits::promote_nocheck(OU));
    // CHECK_EQUAL(TO, PieceTraits::promote_nocheck(TO));
    // CHECK_EQUAL(NK, PieceTraits::promote_nocheck(NK));
    // CHECK_EQUAL(NG, PieceTraits::promote_nocheck(NG));
    // CHECK_EQUAL(UM, PieceTraits::promote_nocheck(UM));
    // CHECK_EQUAL(RY, PieceTraits::promote_nocheck(RY));
    // CHECK_EQUAL(NA, PieceTraits::promote_nocheck(NA));
    ...
    // CHECK_EQUAL(B_KI, PieceTraits::promote_nocheck(B_KI));
    // CHECK_EQUAL(B_OU, PieceTraits::promote_nocheck(B_OU));
    // CHECK_EQUAL(B_TO, PieceTraits::promote_nocheck(B_TO));
    // CHECK_EQUAL(B_NK, PieceTraits::promote_nocheck(B_NK));
    // CHECK_EQUAL(B_NG, PieceTraits::promote_nocheck(B_NG));
    // CHECK_EQUAL(B_UM, PieceTraits::promote_nocheck(B_UM));
    // CHECK_EQUAL(B_RY, PieceTraits::promote_nocheck(B_RY));
    ...
    // CHECK_EQUAL(W_KI, PieceTraits::promote_nocheck(W_KI));
    // CHECK_EQUAL(W_OU, PieceTraits::promote_nocheck(W_OU));
    // CHECK_EQUAL(W_TO, PieceTraits::promote_nocheck(W_TO));
    // CHECK_EQUAL(W_NK, PieceTraits::promote_nocheck(W_NK));
    // CHECK_EQUAL(W_NG, PieceTraits::promote_nocheck(W_NG));
    // CHECK_EQUAL(W_UM, PieceTraits::promote_nocheck(W_UM));
    // CHECK_EQUAL(W_RY, PieceTraits::promote_nocheck(W_RY));
}
...
TEST(judkins_shogi_pieces, make_piece)
{
...
TEST(judkins_shogi_pieces, to_char)
{
...
TEST(judkins_shogi_pieces, to_sfen)
{
    // clang-format off
...
TEST(judkins_shogi_pieces, get_point)
{
...
TEST(judkins_shogi_pieces, get_attack_directions)
{
    ...
    {
        const auto actual = PieceTraits::get_attack_directions(B_KA);
        CHECK_EQUAL(vshogi::DIR_NW, actual[0]);
    ...
    {
        const auto actual = PieceTraits::get_attack_directions(B_HI);
        CHECK_EQUAL(vshogi::DIR_N, actual[0]);
    ...
    {
        const auto actual = PieceTraits::get_attack_directions(W_FU);
        CHECK_EQUAL(vshogi::DIR_S, actual[0]);
        CHECK_EQUAL(vshogi::DIR_NA, actual[1]);
    }
    {
        const auto actual = PieceTraits::get_attack_directions(W_KE);
        CHECK_EQUAL(vshogi::DIR_SSE, actual[0]);
        CHECK_EQUAL(vshogi::DIR_SSW, actual[1]);
        CHECK_EQUAL(vshogi::DIR_NA, actual[2]);
    }
    {
        const auto actual = PieceTraits::get_attack_directions(W_GI);
    ...
    {
        const auto actual = PieceTraits::get_attack_directions(W_KA);
        CHECK_EQUAL(vshogi::DIR_SE, actual[0]);
    ...
    {
        const auto actual = PieceTraits::get_attack_directions(W_HI);
        CHECK_EQUAL(vshogi::DIR_S, actual[0]);
