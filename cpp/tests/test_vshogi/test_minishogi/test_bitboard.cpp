...
TEST(bitboard, gi)
{
    ...
    {
        const auto actual = BitBoard::get_attacks_by_non_ranging(W_GI, SQ_2E);
        CHECK_EQUAL(SQ_3D, actual[0]);
...
TEST(bitboard, ki)
{
    ...
    {
        const auto actual = BitBoard::get_attacks_by_non_ranging(B_KI, SQ_5A);
        CHECK_EQUAL(SQ_4A, actual[0]);
...
TEST(bitboard, to)
{
    ...
    {
        const auto actual = BitBoard::get_attacks_by_non_ranging(B_TO, SQ_5A);
        CHECK_EQUAL(SQ_4A, actual[0]);
        CHECK_EQUAL(SQ_5B, actual[1]);
        CHECK_EQUAL(SQ_NA, actual[2]);
    }
...
TEST(bitboard, ng)
{
    ...
    {
        const auto actual = BitBoard::get_attacks_by_non_ranging(B_NG, SQ_5A);
        CHECK_EQUAL(SQ_4A, actual[0]);
        CHECK_EQUAL(SQ_5B, actual[1]);
        CHECK_EQUAL(SQ_NA, actual[2]);
    }
...
TEST(bitboard, um)
{
    ...
    CHECK_TRUE(nullptr == BitBoard::get_attacks_by_non_ranging(W_UM, SQ_3C));
}
...
TEST(bitboard, hi)
{
    ...
    CHECK_TRUE(nullptr == BitBoard::get_attacks_by_non_ranging(B_HI, SQ_3C));
}
...
TEST(bitboard, ry)
{
    ...
    CHECK_TRUE(nullptr == BitBoard::get_attacks_by_non_ranging(W_RY, SQ_3C));
}
...
TEST(bitboard, ou)
{
    ...
    {
        const auto actual = BitBoard::get_attacks_by_non_ranging(W_OU, SQ_5E);
