...
NUMBER_JPN_SYMBOLS = [
    None, "一", "二", "三", "四", "五", "六", "七", "八", "九", "十", "十一", "十二",
    "十三", "十四", "十五", "十六", "十七", "十八",
]
    ...
    *,
    ...
    svg.append(ElementTree.fromstring(
        ...
        + ''.join([
            ...
            for r, c in zip(range(1, game.ranks + 1), "一二三四五六七八九")
        ])
        + '</g>',
    ))
    ...
    for c in (Color.BLACK, Color.WHITE):
        ...
        for i, text in hand_pieces[c]:
            e = ElementTree.SubElement(svg, "text", {
                "font-family": "serif",
