...
@pytest.mark.parametrize(
    ...
    [
        ...
        (shogi.BoardPiece.B_KY, "L"),
        (shogi.BoardPiece.B_KE, "N"),
        ...
        (shogi.BoardPiece.B_NY, "+L"),
        (shogi.BoardPiece.B_NK, "+N"),
        (shogi.BoardPiece.B_NG, "+S"),
        (shogi.BoardPiece.B_UM, "+B"),
        (shogi.BoardPiece.B_RY, "+R"),
        (shogi.BoardPiece.W_FU, "p"),
        (shogi.BoardPiece.W_KY, "l"),
        (shogi.BoardPiece.W_KE, "n"),
        ...
        (shogi.BoardPiece.W_NY, "+l"),
        (shogi.BoardPiece.W_NK, "+n"),
