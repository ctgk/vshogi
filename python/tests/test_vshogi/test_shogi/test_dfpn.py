...
def test_mate():
    sfen_searches_pair_list = [
        ...
        ('5p+r1S/9/8k/5+B2p/7PN/9/9/9/9 b B10p4l3n3s4gr', 1165),
        ('7p1/5l3/5pk2/6B+r1/5P1P1/6L2/9/9/9 b Rrb4g4s4n3l9p', 5676),
        ('7bk/8p/9/9/9/9/B8/9/9 b N10p4l3n4s4gb2r', 5330),
        ('3R2l2/4r2+B1/5+Bnn1/8k/6G2/8P/7P1/9/9 b 10p3l2n4s4g', 10613),
        ('5+Pnk1/8P/4p1+rsS/9/9/9/9/9/9 b BGS10p4l3ns3gbr', 3680),
        ('4k4/5s+r2/3R1Ls2/3+B5/9/9/9/9/9 b B10p3l4n2s4g', 956),
    ]
